...
class AlienInvasion():
    ...
    def _update_bullets(self):
        ...
        # Here we want to repopulate the fleet
        if not self.aliens:
    ...
    def _check_bullet_alien_collisions(self):
        """Check whether any bullets have hit aliens and remove both bullet and alien. """
    ...
    def _create_fleet(self): 
        ...
        while current_y < (self.settings.screen_height - 3 * alien_height):
            while current_x < (self.settings.screen_width - 2 * alien_width):
                self._create_alien(current_x, current_y)   # Refactored our code so that the alien creation is more manageable
    ...
    def _ship_hit(self):
        """Respond to each ship being hti by an alien. """
    ...
    def _check_aliens_bottom(self):
        """Check if any aliens have raeched teh bottom of the screen. """
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= self.settings.screen_height:
                # We treat it the same as if the ship got hit. 
                self._ship_hit()
                break
    ...
    def _update_screen(self):
        ...
        self.aliens.draw(self.screen)  # Draws the alien to the screen
        self.ship.blitme()
